...
"<Hint: You can enter page number only, and program will decide what all details you might want (Next Entry button will activate accordingly)>");
            ...
            editLabel.setText(EDIT_LABEL_EDITMODE);
            chapterField.setText(tdm.getTerm(inputTerm).getSuperHeadingContent());
            majorTopicField.setText(tdm.getTerm(inputTerm).getMiddleHeadingContent());
            subTopicArea.setText(tdm.getTerm(inputTerm).getSubHeadingContent());
