...
public class NumericAndFirstDigitFilter extends DocumentFilter {
    
    private int maxLength;
    public NumericAndFirstDigitFilter(int maxLength) {
        if (maxLength <= 0) {
...
*/
        ...
        if (proposedText.length() > 0 && proposedText.startsWith("0")) {
            ...
            // (i.e., someone pasted "0123" when the field was empty), allow it.
