...
public class ContentFactory {
    ...
    public static Map<Integer, String[]> getEverythingByPage(int page){
        ...
        returnMap = getEverythingByPageLOOPER(returnMap, Section.SECTION_10_0, page);
        returnMap = getEverythingByPageLOOPER(returnMap, Section.SECTION_10_1, page);
        returnMap = getEverythingByPageLOOPER(returnMap, Section.SECTION_10_2, page);
        returnMap = getEverythingByPageLOOPER(returnMap, Section.SECTION_10_3, page);
        returnMap = getEverythingByPageLOOPER(returnMap, Section.SECTION_10_4, page);
